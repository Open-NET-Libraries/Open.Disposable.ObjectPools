...
public class CollectionWrapperObjectPool<T, TCollection>
	: TrimmableGenericCollectionObjectPoolBase<T, TCollection>
	where T : class
	where TCollection : class, ICollection<T>
{
	public CollectionWrapperObjectPool(
		TCollection pool,
		Func<T> factory,
		Action<T>? recycler,
		Action<T>? disposer,
...
public class CollectionWrapperObjectPool<T>
	: CollectionWrapperObjectPool<T, ICollection<T>>
	where T : class
{
	public CollectionWrapperObjectPool(
		ICollection<T> pool,
